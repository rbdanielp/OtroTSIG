...
import uy.tsig.grupo12.ctrlEntidades.POI.exceptions.exceptions.exceptions.exceptions.exceptions.PromocionJpaController;
 ...
 * @author tecnoinf
 */
public class IngresarPromocion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/Auth/IngresarPromocion.jsp").forward(request, response);
    }
