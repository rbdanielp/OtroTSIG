...
*/
   ...
   @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int golesE1 = Integer.parseInt(request.getParameter("golesE1"));
        int golesE2 = Integer.parseInt(request.getParameter("golesE2"));
        FachadaLogica.getPartidoController().ingresarResultado(idPartido, golesE1, golesE2);         
